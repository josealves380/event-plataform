        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 mt-6">
            <img
              ...
              src="https://github.com/josealves380.png" 
              alt="" 
              />
            <div className="leading-relaxed">
              <strong className="font-bold text-2xl block">José Alves</strong>
              <span className="text-gray-200 text-sm block">Profº Tec.Informática</span>
            </div>
          </div>
